...
INSERT INTO `companydata` VALUES (1,NULL,'SSG',NULL,'',NULL,'',NULL,'',NULL,NULL,NULL,NULL,_binary '\0',_binary '\0','2024-10-18 19:13:03',2,'1234','ssg@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'tcs.com','TCS','Whitefield','9876543210','GSTIN98753146','Usha','Bangalore','Bangalore','Karnataka','577054','India',1,_binary '\0',_binary '\0','2024-10-21 09:59:37',2,'tcs@123','tcs@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `jobpostings_eligiblestudents` (
  ...
  CONSTRAINT `FK_JobPostingEligible_Status` FOREIGN KEY (`StatusId`) REFERENCES `jobstudentstaus` (`Id`),
...
--
-- Table structure for table `jobstudentstaus`
--

DROP TABLE IF EXISTS `jobstudentstaus`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `jobstudentstaus` (
...
--
-- Dumping data for table `jobstudentstaus`
--

LOCK TABLES `jobstudentstaus` WRITE;
/*!40000 ALTER TABLE `jobstudentstaus` DISABLE KEYS */;
/*!40000 ALTER TABLE `jobstudentstaus` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-10-23 16:16:24
