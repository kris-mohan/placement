...
CREATE TABLE `jobinterviewpanels` (
  ...
  `JoInterviewRoundId` bigint DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `FK_Round_JobPosting_idx` (`JobPostingId`),
  KEY `FK_Round_JobInterviewRound_idx` (`JoInterviewRoundId`),
  CONSTRAINT `FK_Round_JobInterviewRound` FOREIGN KEY (`JoInterviewRoundId`) REFERENCES `jobinterviewrounds` (`Id`),
  CONSTRAINT `FK_Round_JobPostings` FOREIGN KEY (`JobPostingId`) REFERENCES `jobposting` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-21 12:07:19
