...
INSERT INTO `collegejobposting` VALUES (1,2,1),(2,1,1),(3,4,1),(4,5,1),(5,6,1),(6,8,1),(7,11,2),(8,11,3),(9,12,1),(10,12,2),(11,12,3),(12,13,5),(13,14,1);
...
INSERT INTO `company_job_batch` VALUES (1,10,2),(2,10,3),(3,11,3),(4,11,4),(5,11,5),(6,11,6),(7,12,5),(8,12,6),(9,13,6),(10,13,7),(11,14,6),(12,14,7);
...
INSERT INTO `company_job_course` VALUES (1,11,1),(2,11,5),(3,12,1),(4,12,5),(5,13,16),(6,13,17),(7,14,5);
...
CREATE TABLE `studentacademics` (
  ...
  `TenthMarks` decimal(10,0) DEFAULT NULL,
  `TwelthMarks` decimal(10,0) DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
INSERT INTO `studentacademics` VALUES (1,1,1,1,8,NULL,NULL),(2,2,5,1,7,NULL,NULL),(3,3,2,1,7,NULL,NULL);
...
-- Dump completed on 2024-11-04  9:51:02
