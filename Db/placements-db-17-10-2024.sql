...
INSERT INTO `campusregistration` VALUES (1,'jnnce','jnnce@gmail.com','1234','sunil','jnnce@gmail.com',123456789,'shimoga','karnataka','india','577223','2024-10-04 09:46:54',_binary '\0',_binary '\0',1);
...
INSERT INTO `companyregistration` VALUES (1,'ssg','ssg@gmail.com','','','',_binary '\0',_binary '\0',2,'1234',NULL),(2,'capgemini','capgemini@gmail.com','doom','bangalore','1234567689',_binary '\0',_binary '\0',2,'1234','2024-10-04 09:41:59');
...
CREATE TABLE `login` (
  ...
  CONSTRAINT `FK_Login_Role` FOREIGN KEY (`RoleId`) REFERENCES `role` (`Id`),
...
INSERT INTO `login` VALUES (1,NULL,'capgemini@gmail.com','1234','2024-10-04 09:41:59',NULL,NULL,_binary '\0',2,_binary '\0',NULL),(2,NULL,'jnnce@gmail.com','1234','2024-10-04 09:46:54',NULL,NULL,_binary '\0',1,_binary '\0',NULL),(3,NULL,'student@gmail.com','123','2024-10-04 11:00:02',NULL,NULL,_binary '\0',3,_binary '',NULL);
...
INSERT INTO `studentregistartion` VALUES (1,'usha','R123460','student@example.com','1234567890',105,'2026','Information Technology',_binary '\0',_binary '',3,'123','2024-10-04 10:59:50');
...
-- Dump completed on 2024-10-17 17:08:26
