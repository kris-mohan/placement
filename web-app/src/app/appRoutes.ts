...
import { TrainingScheduleAttendanceComponent } from './features/training-configuration/training-configuration/training-schedule-attendance/training-schedule-attendance.component';
import { StudentResponseDialogComponent } from './features/training-configuration/training-configuration/training-feedback/student-response-dialog/student-response-dialog.component';
import { StudentFeedbacksListComponent } from './features/training-configuration/training-configuration/training-feedback/student-feedbacks-list/student-feedbacks-list.component';
import { ScheduleDialogComponent } from './features/training-configuration/training-configuration/training-feedback/schedule-dialog/schedule-dialog.component';
import { StudentTrainingFeedbackComponent } from './features/student-menu/student-menu/student-training-feedback/student-training-feedback.component';
import { StudentResponseComponent } from './features/student-menu/student-menu/student-training-feedback/student-response/student-response.component';
...
const appRoutes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'training-configuration/ts-attendance',
        component: TrainingScheduleAttendanceComponent,
      },
      {
        path: 'training-configuration/tf-student',
        component: StudentResponseDialogComponent,
      },
      {
        path: 'training-configuration/student-feedback',
        component: StudentFeedbacksListComponent,
      },
      {
        path: 'training-configuration/training-schedule',
        component: ScheduleDialogComponent,
      },
      {
        path: 'ts-feedback',
        component: StudentTrainingFeedbackComponent,
      },
      {
        path: 'ts-feedback/student-response',
      ...
      {
        path: 'interview/interview-students-list/student-result-information/:jobPostingId/:roundId/:studentId/:currentRoundIndex',
        component: StudentResultInformation,
      },
      {
        path: 'testr',
