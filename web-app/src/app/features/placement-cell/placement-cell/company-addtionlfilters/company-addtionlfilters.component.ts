...
@Component({
  selector: "app-company-addtionlfilters",
  standalone: true,
  imports: [CommonModule, SharedModule, AMGModules, NgxMatSelectSearchModule],
  templateUrl: "./company-addtionlfilters.component.html",
  styleUrl: "./company-addtionlfilters.component.css",
})
export class CompanyAddtionlfiltersComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CompanyAddtionlfiltersComponent>
  ) {}
