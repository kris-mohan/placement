...
@Component({
  selector: "app-student-interview-addtionalfilter",
  standalone: true,
  imports: [CommonModule, SharedModule, AMGModules, NgxMatSelectSearchModule],
  templateUrl: "./student-interview-addtionalfilter.component.html",
  styleUrl: "./student-interview-addtionalfilter.component.css",
})
export class StudentInterviewAddtionalfilterComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<StudentInterviewAddtionalfilterComponent>
  ) {}
