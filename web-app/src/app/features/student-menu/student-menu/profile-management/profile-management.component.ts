...
export class ProfileManagementComponent {
  ...
  // getCourseByStreamId(id: number) {
  //   this.studentApiService.GetCoursesByStreamId(id).subscribe({
  //     next: (course) => {
  //       const data: Course[] = course.value;
  //       this.Courses.set(data);
  //       console.log("Courses by Stream Id", id, " ", this.Courses());
  //     },
  //   });
  // }

  // onStreamSelected = (event: any): void => {
  //   const selectedStreamId = event.value;
  //   console.log(selectedStreamId);
  // this.getCourseByStreamId(selectedStreamId);
  // };
